...
/**
 * This is the model class for table "plano_hospital".
 *
 * The followings are the available columns in table 'plano_hospital':
...
class plano_hospital extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('codplano, codhospital', 'required'),
            array('codplano, codhospital', 'numerical', 'integerOnly'=>true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('codplano, codhospital', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('codplano',$this->codplano);
     ...
     * @return PlanoHospital the static model class
     */
